        ...
        @Operation(description="M",
            responses= {
                ...
                @ApiResponse(responseCode = "404", description = "Identificativo non trovato", content=@Content(schema=@Schema(implementation=ErrorMessage.class)),
                        headers={
                            @Header(name="X-RateLimit-Limit", description="Limite massimo richieste", schema=@Schema(implementation=Integer.class)),
                            @Header(name="X-RateLimit-Remaining", description="Chiamate rimanenti", schema=@Schema(implementation=Integer.class)),
                            @Header(name="X-RateLimit-Reset", description="Secondi dal reset del limite", schema=@Schema(implementation=Integer.class))
                }),
                ...
                @ApiResponse(responseCode = "400", description = "Richiesta malformata", content=@Content(schema=@Schema(implementation=ErrorMessage.class)),
                        headers={
                            @Header(name="X-RateLimit-Limit", description="Limite massimo richieste", schema=@Schema(implementation=Integer.class)),
                            @Header(name="X-RateLimit-Remaining", description="Chiamate rimanenti", schema=@Schema(implementation=Integer.class)),
                            @Header(name="X-RateLimit-Reset", description="Secondi dal reset del limite", schema=@Schema(implementation=Integer.class))
                }),
                @ApiResponse(responseCode = "429", description = "Limite di richieste raggiunto", content=@Content(schema=@Schema(implementation=ErrorMessage.class)),
                        headers={
                            @Header(name="Retry-After", description="Limite massimo richieste", schema=@Schema(implementation=Integer.class))
                })
            })
